...
trait HellooAttribute
{
    ...
    {
        return '<a href="' .
            route('admin.helloo.destroy', $this) .
            '"
			 data-method="delete"
    ...
    {
        return '<div
       class="btn-group btn-group-sm" helloo="group" aria-label="Helloo Actions">
	   		 ' .
            $this->view_button .
            '
			  ' .
